...
import com.lcg.gift.bean.ExceptionLog;
import com.lcg.gift.net.DataHandler;
import com.lcg.gift.net.HttpManager;
import com.lcg.gift.utils.L;
import com.lcg.gift.utils.MD5;
import com.lcg.gift.utils.ThreadPoolUntil;
...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    private void sendMsg(final File file, String msg) {
        HttpManager.getInstance().post(HttpUrl.APPLOGS, msg,
                new DataHandler() {
                    @Override
                    public void start() {
                    }
